...
def file_to_dict(filename):
    content_dict_file = open(filename, 'rt')  # read text
...
if __name__ == '__main__':
    while True:
        ...
        for i in range(1, 6):
            fname_dl = fname_prefix + '_' + str(i)  # filename to be downloaded
            ...
            for ip in content_dict[fname_dl]:
                ...
                try:
                    ...
                    with open("downloaded_chunks/" + fname_dl, 'wb') as f:  # write binary
                        f.write(dl_chunk)
